function listOrders(orders) {
  _.each(orders, function (order) {
    order._status = ({
      ...
      WAIT_SELLER_CONFIRM_GOODS: '买家已退货,等待卖家收货',
      REFUND_CLOSED: '已退款(发货前)',
      REFUND_SUCCESS: '已退货(发货后)',
      OFFLINE_TRADE_FINISHED: '交易完成',
      OFFLINE_TRADE_CLOSED: '订单已取消',
      OFFLINE_WAIT_SELLER_CONFIRM_MONEY: '买家已付款,等待卖家确认',
      OFFLINE_WAIT_BUYER_CONFIRM_GOODS_AND_PAY: '卖家已发货,等待买家收货付款',
      ...
      OFFLINE_WAIT_SELLER_CONFIRM_GOODS: '买家已退货,等待卖家收货',
